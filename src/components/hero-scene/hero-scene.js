...
const HeroScene = ({ showLightTheme, t }) => {
  ...
  const slideTitleToLeft = (e) => {
    ...
    heroTitleOne.current.style.transform = `matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,${
      (distanceFromTop - containerTop) * 0.5
    },0,0,1)`;
    heroTitleTwo.current.style.transform = `matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,${
      (distanceFromTop - containerTop) * -0.5
    },0,0,1)`;
  };
  ...
  const moveCircles = (e) => {
    ...
    circleTop.current.style.transform = `matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,${
      distanceFromMiddleX * -0.2
    },${distanceFromMiddleY * -0.1},0,1)`;
    circleBottom.current.style.transform = `matrix3d(1,0,0.00,0,0.00,1,0.00,0,0,0,1,0,${
      distanceFromMiddleX * 0.2
    },${distanceFromMiddleY * -0.1},0,1)`;
  };
  ...
  useEffect(() => {
    ...
    heroContainer.addEventListener(
      "mousemove",
      (e) => {
        onCursorMove(e, heroContainer, mouseContainer, 75);
      },
      false
    );
    return () =>
      heroContainer.removeEventListener(
        "mousemove",
        (e) => {
          onCursorMove(e, heroContainer, mouseContainer, 75);
        },
  ...
  useEffect(() => {
    ...
    return () =>
      heroContainer.removeEventListener("mousemove", moveCircles, false);
  }, []);
  ...
  return (
    <section
      ...
      style={{
        background: showLightTheme
          ? "linear-gradient(rgb(71, 150, 247) 0%, rgb(72, 185, 239) 100%)"
          : "linear-gradient(180deg, #0a0c13 0%, #15192b 100%)",
      }}
    >
      <div className="hero-scene-wrapper">
        ...
        <ul className="skillset">
          ...
          <li className="tools">
            REACT.JS - TYPESCRIPT - NEXTJS - REDUX - WEBSOCKETS
          </li>
          <br />
          <li>UI DESIGN</li>
          <li className="tools">ADOBE - ZEPLIN</li>
        </ul>
